                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <div class="main-header">
                                ...
                                <ul class="navbar-nav ">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link " role="button" id="Club" href="#"
                                            data-bs-toggle="dropdown" aria-expanded="false">Club<i
                                                class="fa-regular fa-chevron-down fa-xs"></i></a>
                                        <div class="dropdown-menu" id="club-dropdown" aria-labelledby="Club">
                                            <div class="d-flex align-items-start">
                                                <div class="nav flex-column nav-pills me-3" id="v-pills-tab"
                                                    ...
                                                    <button class="nav-link" id="pills-profile-tab"
                                                        ...
                                                        League</button>
                                                    <button class="nav-link" id="pills-messages-tab"
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="nationalleague.php" id="nation-nav">Nation<i
                                                class="fa-regular fa-chevron-down fa-xs"></i></a>
                                        <div class="dropdown-menu" id="nation-dropdown" aria-labelledby="nation-nav">
                                            <div class="d-flex align-items-start">
                                                <div class="nav flex-column nav-pills me-3" id="v-pills-tab"
                                                    role="tablist" aria-orientation="vertical">
